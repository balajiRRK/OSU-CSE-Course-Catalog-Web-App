# created with the use of pagy documentation https://ddnexus.github.io/pagy/quick-start/
...
#
# load the "de" locale defined in the custom file at :filepath:https://ddnexus.github.io/pagy/quick-start/
#
